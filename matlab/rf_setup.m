...
%% Turn on tone
%
b4d_send_command('127.0.0.1','A','fmc111_set_ms_filt TX A x7');

%set tonetest freq
b4d_send_command('127.0.0.1','A','fmc111_set_lo_freq TX A 2430000')
...
b4d_send_command('127.0.0.1','A','fmc111_set_atten RX AB 0');
